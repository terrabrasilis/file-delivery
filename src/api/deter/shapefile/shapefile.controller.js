...
import Service from './shapefile.service'
moment.locale('pt-BR')
...
const Controller = {
  ...
  processResponse(ctx, userProfile)
  {
    ...
    if(project)
    {
      const filePath = Service.getFileBasedOnProfile(userProfile, project)
    ...
    {
      ctx.body = { error: 'Missing paramater, syntax is: /deter/shapefile/:project' };
      return;
    }
