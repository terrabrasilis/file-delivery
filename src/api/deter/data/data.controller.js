...
const Controller = {
  ...
  processResponse(ctx, userProfile)
  {
    ...
    {
      const filePath = Service.getFileBasedOnProfile(userProfile, project, granularity, loi)
    ...
    {
      ctx.body = { error: 'Missing paramater, syntax is: /deter/data/:biome/:granularity/:loi' };
      return;
    }
